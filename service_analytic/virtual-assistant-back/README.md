...
Импорт корневых запросов и минус слов проводится из csv-файла от SEO-аналитика Артема Маренко с административных страниц:
...
Импорт поисковых запросов проводится с ftp, куда файлы подкладывает подрядчик RUFAGO.
