...
return [
    ...
    */
    ...
    'user_company' => [
        'role' => 'Недостаточно прав для этого действия.',
        'user_not_in_company' => 'Пользователь не привязан к компании.',
        'user_in_company' => 'Пользователь с таким e-mail уже является сотрудником компании :company',
        'active_service' => 'У компании не активирован сервис :service',
        'statuses' => [
            'active' => 'Активен',
            'blocked' => 'Заблокирован',
            'deleted' => 'Удален',
        ],
        'company_owner' => 'Невозможно удалить владельца компании',
        'last_role' => 'У пользователя осталась 1 роль.',
        'count' => 'В компании уже :count сотрудников.',
        'payment_is_company_owner' => 'Компания уже зарегистрирована, корпоративный доступ доступен только для владельца компании. Если это ваша компания, обратитесь в поддержку',
    ],

    'user_accaunt' => [
        'user_has_accaunt' => 'У пользователя нет доступа к этому аккаунту.',
    ],

    'final_price' => [
        'sku' => 'Максимум возможно 10000 sku',
    ],

    'phone' => [
        'format' => 'Телефон должен состоять только из чисел и содержать минимум 10 знаков.'
    ],
    ...
    'password' => [
        'format' => 'Пароль обязательно должен содержать одну заглавную, одну прописную букву латинского алфавита, а также одну цифру',
    ]
];
