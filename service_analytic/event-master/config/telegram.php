...
use App\Services\Bots\Telegram\Callbacks\ToggleSubscription\ToggleSubscriptionCallback;
...
return [
    ...
    */
    'bots' => [
        'default_bot' => [
            ...
            'webhook_url'      => env('TELEGRAM_WEBHOOK_URL', sprintf('%s/api/v1/%s/updates', env('APP_URL_HTTPS'), env('TELEGRAM_BOT_TOKEN'))),
            'commands'         => [
                \App\Services\Bots\Telegram\Commands\StartCommand::class,
                \App\Services\Bots\Telegram\Commands\SubscriptionsCommand::class,
            ],
        ],
    ...
    */
    'commands' => [
        \App\Services\Bots\Telegram\Commands\HelpCommand::class
    ],

    'callbacks' => [
        ToggleSubscriptionCallback::class => ToggleSubscriptionData::class
    ],
