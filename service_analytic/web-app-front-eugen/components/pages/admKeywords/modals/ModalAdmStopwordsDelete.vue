            ...
            async handleConfirm() {
                try {
                    ...
                    const response = await this.$axios.$delete(
                        ...
                        {
                            params: {
                                stop_word_ids: this.items.map(item => item.id),
                    ...
                    console.log(
                        '🚀 ~ file: ModalAdmStopwordsDelete.vue ~ line 87 ~ handleConfirm ~ response',
                        response
                    );
                    if (!response?.success) {
                        throw new Error('err');
                    ...
                    console.log(
                        '🚀 ~ file: ModalAdmStopwordsDelete.vue ~ line 109 ~ handleConfirm ~ error',
                        error
                    );
