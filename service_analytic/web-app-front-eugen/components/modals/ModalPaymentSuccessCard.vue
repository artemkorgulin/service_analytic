            ...
            <VFadeTransition mode="out-in" appear>
                ...
                <div v-else key="content" :class="$style.inner">
                    ...
                    <VImg
                        ...
                        alt="успешно"
                    />
                    <h2 :class="$style.heading">Оплата прошла успешно</h2>
                    <div :class="$style.btnWrapper">
                        <VBtn :class="$style.btn" outlined @click="handleClose">Закрыть</VBtn>
                    </div>
                </div>
            </VFadeTransition>
        </VCard>
...
<script>
    ...
    export default {
        ...
        computed: {
            getButtonMethod() {
                return this.isInvoice ? this.getInvoice : this.handlePayCard;
            },
        },
        // mounted() {
        //     console.log('ModalPaymentSuccess ', this);
        // },
        methods: {
            async handleConfirm() {
                this.isLoading = true;
