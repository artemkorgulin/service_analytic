...
<script>
    ...
    export default {
        name: 'ProductsListIconAdvertizing',
        ...
        data() {
            return {
                messages: {
                    on: 'Товар рекламируется',
                    off: 'Товар не рекламируется',
                },
            };
        },
        computed: {
            ...
            getColorClass() {
                if (this.status === 1) {
                    return this.$style.AdvOn;
                } else {
                    return this.$style.AdvOff;
                }
            },
            getIcon() {
                if (this.status === 1) {
                    return 'filled/speakerUp';
                } else {
                    return 'filled/speakerMid';
                }
            },
        },
    };
