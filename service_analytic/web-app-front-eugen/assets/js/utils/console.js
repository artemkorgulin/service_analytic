function createMessage(message, vm, parent) {
    ...
    return `[Global] ${message}` + (vm ? generateComponentTrace(vm) : '');
}
...
export function consoleWarn(message, vm, parent) {
    console.log('🚀 ~ file: console.js ~ line 33 ~ consoleWarn ~ message', message);
    const newMessage = createMessage(message, vm, parent);
    console.log('🚀 ~ file: console.js ~ line 34 ~ consoleWarn ~ newMessage', newMessage);
    if (!newMessage) {
        return;
    }
